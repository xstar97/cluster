...
DOWNLOAD_DIR="/home/xstar97/Desktop/tmp"
INSTALL_DIR="/usr/local/bin"
BACKUP_DIR="/home/xstar97/Desktop/backup"
...
download_and_install() {
    ...
    ARCHIVE_NAME="clustertool_${LATEST_TAG//v/}_${ARCH}.tar.gz" # Remove 'v' from the tag
    DOWNLOAD_URL="https://github.com/$GITHUB_REPO/releases/download/$LATEST_TAG/$ARCHIVE_NAME"

    echo "Downloading $ARCHIVE_NAME for architecture $ARCH from $DOWNLOAD_URL..."
